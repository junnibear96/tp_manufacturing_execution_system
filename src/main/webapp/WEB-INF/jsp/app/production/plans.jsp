          ...
          <section class="hero" aria-label="Plans">
            <div class="hero-grid">
                      ...
                      <c:forEach items="${plans}" var="p">
                        <tr>
                          <td style="padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.08);">
                            <c:out value="${p.planDate}" />
                          </td>
                          <td style="padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.08);">
                            <c:out value="${p.itemCode}" />
                          </td>
                          <td style="padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.08);">
                            <c:out value="${p.qtyPlan}" />
                          </td>
                          <td style="padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.08);">
                          ...
                          <c:if
                            ...
                            <td style="padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.08);">
                              <form method="post"
                                action="${pageContext.request.contextPath}/admin/production/plans/delete"
              ...
              <aside class="card" aria-label="Admin">
                ...
                <c:if test="${sessionScope.AUTH_USER != null && sessionScope.AUTH_USER.hasRole('ROLE_ADMIN')}">
                  <p><a class="btn" href="${pageContext.request.contextPath}/admin/production/plans/new">+ New Plan</a>
                  </p>
                </c:if>
