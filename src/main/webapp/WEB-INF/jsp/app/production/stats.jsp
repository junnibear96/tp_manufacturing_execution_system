  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
      ...
      <head>
        ...
        <title>
          <spring:message code="app.stats.title" text="생산 통계" /> - TP
        </title>
          ...
          <section class="hero" aria-label="Stats">
            <div class="hero-grid">
              <div class="card card-strong">
                ...
                <h1>
                  <spring:message code="app.stats.header.daily" text="통계(최근 14일)" />
                </h1>
                    ...
                    <thead>
                      <tr>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.stats.col.day" text="Day" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.stats.col.plan" text="Plan" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.stats.col.good" text="Good" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.stats.col.ng" text="NG" />
                        </th>
                      </tr>
                    </thead>
                    <tbody>
              ...
              <aside class="card" aria-label="Monthly">
                <h2 style="margin-top:0;">
                  <spring:message code="app.stats.header.monthly" text="월 통계(올해)" />
                </h2>
                <div style="overflow:auto;">
                  <table style="width:100%; border-collapse:collapse;">
                    <thead>
                      <tr>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.stats.col.month" text="Month" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.stats.col.plan" text="Plan" />
                        </th>
