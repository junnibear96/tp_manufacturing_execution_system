  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
      ...
      <head>
        ...
        <title>
          <spring:message code="app.equipment.title" text="설비" /> - TP
        </title>
          ...
          <main class="container" role="main">
            <section class="hero" aria-label="Equipment">
              <div class="card card-strong">
                ...
                <h1>
                  <spring:message code="app.equipment.title" text="설비" />
                </h1>
                    ...
                    <thead>
                      <tr>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.equipment.header.code" text="Code" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.equipment.header.name" text="Name" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.equipment.header.process" text="Process" />
                        </th>
                        <th style="text-align:left; padding:10px 8px; border-bottom:1px solid rgba(255,255,255,.12);">
                          <spring:message code="app.equipment.header.active" text="Active" />
                        </th>
                      </tr>
                    </thead>
                    <tbody>
