    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>📦 <c:choose>
                            <c:when test="${empty item.inventoryId}">새 재고 등록</c:when>
                            <c:otherwise>재고 수정</c:otherwise>
                        </c:choose>
                    </h1>
                </div>
                ...
                <div class="card">
                    <form method="post"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label class="form-label">
                                    현재 재고<span class="required">*</span>
                                </label>
                            ...
                            <div class="form-group">
                                <label class="form-label">
                                    최소 재고<span class="required">*</span>
                                </label>
                        ...
                        <div class="button-group">
                            <button type="submit" class="btn btn-primary">
                                <c:choose>
                                    <c:when test="${empty item.inventoryId}">등록하기</c:when>
                                    <c:otherwise>수정하기</c:otherwise>
                                </c:choose>
                            </button>
                            <a href="/inventory/list" class="btn btn-secondary">취소</a>
                        </div>
                    </form>
                </div>
            </div>
