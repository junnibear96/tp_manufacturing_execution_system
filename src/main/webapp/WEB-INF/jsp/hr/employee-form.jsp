<%@ page pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>
                <c:if test="${mode == 'new'}">사원 등록</c:if>
                <c:if test="${mode == 'edit'}">사원 정보 수정</c:if> - TP MES
            </title>
            <style>
                * {
                    margin: 0;
        ...
        <body>
            <%@ include file="../include/header.jspf" %>
                ...
                <div class="container">
                    <h1>
                        <c:if test="${mode == 'new'}">📝 신규 사원 등록</c:if>
                        <c:if test="${mode == 'edit'}">✏️ 사원 정보 수정</c:if>
                    </h1>
                    <p class="subtitle">
                        ...
                        <form method="post" action="<c:if test='${mode == " new"}'>/hr/employees</c:if>
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-row">
                                    ...
                                    <option value="LEAVE" <c:if test="${employee.status == 'LEAVE'}">selected</c:if>>휴직
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="shiftType">
                                    ...
                                    <option value="SWING" <c:if
                                        test="${mode == 'edit' && employee.shiftType == 'SWING'}">selected</c:if>>중간조
                                    </option>
                                    <option value="NIGHT" <c:if
                                        test="${mode == 'edit' && employee.shiftType == 'NIGHT'}">selected</c:if>>야간조
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="form-actions">
                        <a href="/hr/employees" class="btn btn-secondary">취소</a>
                        <button type="submit" class="btn btn-primary">
                            <c:if test="${mode == 'new'}">등록</c:if>
