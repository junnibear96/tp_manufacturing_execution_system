            ...
            <body>
                <div class="container">
                    ...
                    <div class="page-header">
                        <h1>📈 분석 리포트</h1>
                        <p class="subtitle">기간별 생산 실적 및 불량률 분석</p>
                    </div>
                    ...
                    <div class="section">
                        <form action="/production/analytics" method="GET" class="filter-form">
                            ...
                            <button type="submit" class="btn btn-search" style="margin-bottom: 2px;">조회</button>
                        </form>
                    </div>

                    <div class="section">
                        <div class="section-title">📊 일별 생산 달성률</div>
                        <table>
                            <thead>
                                <tr>
                                    <th>날짜</th>
                            ...
                            <tbody>
                                <c:forEach items="${dailyAchievement}" var="daily">
                                    <tr>
                                        ...
                                        <td>${daily.completedPlanCount} / ${daily.planCount} 건</td>
                                    </tr>
                                </c:forEach>
                                <c:if test="${empty dailyAchievement}">
                                    <tr>
                                        <td colspan="6" style="text-align: center; padding: 30px; color: #a0aec0;">데이터가
                                            없습니다.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                    ...
                    <div class="section">
                        <div class="section-title">📉 라인별 불량률 분석</div>
                        <table>
                            <thead>
                                <tr>
                                    <th>라인</th>
                            ...
                            <tbody>
                                ...
                                <c:if test="${empty defectRates}">
                                    <tr>
                                        <td colspan="4" style="text-align: center; padding: 30px; color: #a0aec0;">데이터가
                                            없습니다.</td>
                                    </tr>
                                </c:if>
                            </tbody>
