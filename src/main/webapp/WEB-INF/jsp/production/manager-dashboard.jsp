                    ...
                    <div class="container">
                        ...
                        <div class="section">
                            ...
                            <div class="equipment-grid">
                                <c:forEach items="${equipment}" var="eq">
                                    <div class="equipment-item ${eq.status.name().toLowerCase()}">
                                        <div class="equipment-name">${eq.equipmentName}</div>
                                        <div style="font-size: 12px; color: #718096;">${eq.equipmentCode}</div>
                                        <div>
                                            <span class="equipment-status status-${eq.status.name().toLowerCase()}">
                                                ${eq.status.description}
                                            </span>
                                        </div>
                                        <c:if test="${eq.utilizationRate != null}">
                                            <div style="margin-top: 8px; font-size: 13px; font-weight: 600;">
                                                가동률:
                                                <fmt:formatNumber value="${eq.utilizationRate}" pattern="#,##0.0" />%
                                            </div>
                                        </c:if>
                                    </div>
                                </c:forEach>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${dailyAchievement}" var="daily">
                                        <tr>
                                            <td>
                                                <fmt:formatDate value="${daily.workDate}" pattern="yyyy-MM-dd" />
                                            </td>
