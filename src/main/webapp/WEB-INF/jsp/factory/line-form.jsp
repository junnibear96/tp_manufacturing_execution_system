                ...
                <div class="container">
                    <div class="form-container">
                        ...
                        <form method="post" action="/factory/lines">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label>라인명 <span class="required">*</span></label>
                                    <input type="text" name="lineName" required placeholder="예: 조립 라인 1">
                                </div>

                                <div class="form-group">
                                    <label>라인 유형 <span class="required">*</span></label>
                            ...
                            <div class="form-actions">
                                <a href="/factory/lines" class="btn btn-secondary">취소</a>
